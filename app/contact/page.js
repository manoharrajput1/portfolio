...
const Contact = () => {
  ...
  return (
    <form className= ' flex flex-col text-midnight items-center m-2'>
      <input className='m-1 text-blue text-center rounded-lg placeholder-blue bg-gradient-to-r from-indigo-400 via-purple-500 to-pink-500' type='text' name='username' value={user.username} onChange={setUserData} placeholder='Username' required />
